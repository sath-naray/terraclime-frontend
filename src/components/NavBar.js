                  ...
                  <div className="flex md:order-2">
                    ...
                    <div className="relative md:block">
                        <div className="px-2 py-2 ms-3 text-gray-600">
                              <div className="absolute top-0 left-7"><span className="bg-red-300 text-xs rounded-3xl px-2 animate-pulse"></span></div>
                              <button><Megaphone01Icon size={21}/></button>
                        </div>
                    </div>
                    <div className="relative md:block">
                        <div className="px-2 py-2 ms-3 text-gray-600"><button><Notification03Icon size={21}/></button></div>
                    </div>
                    <div className="relative md:block">
                        <div className="px-2 py-2 ms-3 text-gray-600"><button><UserSharingIcon size={21}/></button></div>
                    </div>
